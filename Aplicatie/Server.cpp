...
void Server::handlePutPath(char* path) {

}

void Server::handlePostPath(char* path) {

}

void Server::handleStaticFile(const char* filename, const char* contentType, int client_socket) {
...
const char* Server::getContentType(char* filename) {
...
int Server::parseURLParam(char* path, URLParameters params[], int maxSize) {
...
void Server::handleSearch(char* path, int client_socket) {
...
void Server::handleGetPath(char* path, int client_socket) {
